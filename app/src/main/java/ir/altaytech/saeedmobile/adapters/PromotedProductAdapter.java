...
public class PromotedProductAdapter {
    ...
    public static class PromotedProductsAdapter extends RecyclerView.Adapter<PromotedProductsAdapter.ProductViewHolder> {
        ...
        public PromotedProductsAdapter(Context mCtx, List<Product> productList, ClickListener listener) {
        ...
        public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = inflater.inflate(R.layout.item_promotedproduct_list, parent, false);
        ...
        public void onBindViewHolder(final ProductViewHolder holder, final int position) {
            ...
            holder.textViewFinalPrice.setText(price);
